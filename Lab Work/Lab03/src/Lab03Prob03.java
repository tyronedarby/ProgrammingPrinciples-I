...
//		double year = creditLeft * 2;
		...
		int totalYear = creditLeft / 30; 
		int totalSemesterLeft = creditLeft  % 15 / 2;
		int totalCreditLeft = totalYear % 15; 
		...
		System.out.println("You have " + totalYear + " year(s), "+ totalSemesterLeft + " semester(s), and " + totalCreditLeft + " credit hour(s) (@ 2 semesters/year) left\n"
				+ "until graduation.");
	}
